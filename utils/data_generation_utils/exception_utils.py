...
class AgentIsStuckException(PlannerFailedException):
    pass
...
class PlannerFailedToSeeException(PlannerFailedException):
    ...
    pass
#TODO ainaz remove this exception
class PlannerFailedToSeeEnoughPixelsException(PlannerFailedException):
    "Planner Failed to see the enough pixels of the object"
    pass

#TODO ainaz remove this exception
class PlannerFailedToSeeObjectIn2MException(PlannerFailedException):
    "Planner Failed to see the object with in 2 meters"
    pass

#TODO ainaz remove this exception
class PlannerFailedMaxSteps(PlannerFailedException):
    "Planner Failed after max steps"
    pass
...
class IrrecoverableExplorationCoverageException(IrrecoverablePlannerFailureDueToHouseException):
    pass
